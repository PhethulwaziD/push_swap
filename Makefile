...
SOURCES = error.c assign_array.c check_repeat.c swap_a.c swap_b.c check_sort.c\
		  swap_ab.c push_a.c push_b.c rotate_a.c rotate_b.c rotate_ab.c sort_b.c\
		  ...
		  pb_condition.c smallest.c rrb_condition.c rb_condition.c sort_hundred.c five_hundred_sort.c
